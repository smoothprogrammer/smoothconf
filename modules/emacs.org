...
Disable TAB indentation and leave it to major mode.
...
#+begin_src elisp :tangle no :noweb-ref smooth-motion
  ...
  ("[" backward-paragraph :name paragraph-up :select activate)
  ("]" forward-paragraph :name paragraph-down :select activate)
  ...
  ("{" backward-paragraph :name extend-paragraph-up :select extend)
  ("}" forward-paragraph :name extend-paragraph-down :select extend)
