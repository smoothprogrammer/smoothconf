...
+ fix completion for function args
  ...
  (use-package ryo-modal
    ...
    (defun smooth/universal-escape ()
      ...
      (cond
  	 ...
  	 ;; 2. Vertico minibuffer
  	 ((when (minibufferp)
  	  (minibuffer-keyboard-quit)))

  	 ;; 3. Minibuffer fallback
  	 ((minibufferp)
  	  (minibuffer-keyboard-quit))

  	 ;; 4. Enter ryo-modal-mode
       (t (ryo-modal-mode))))
...
* Movement and selection :h:j:k:l:v:w:semicolon:
...
#+begin_src elisp :tangle no :noweb-ref xref
  ...
  ("g h" xref-go-back :name "go back")
  ("g l" xref-go-forward :name "go forward")
#+end_src

#+begin_src elisp :tangle no :noweb-ref consult
  ("g i" consult-imenu :name "go to index menu")
