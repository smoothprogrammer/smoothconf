...
I'm still an Emaacs noob, more help are welcome.
...
Need to assess below general Org configuration.
...
+ C-c C-v t :: manually tangle
+ C-x C-s :: save buffer (trigger =org-auto-tangle-mode=)
